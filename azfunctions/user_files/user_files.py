        ...
        for file_metadata in files_metadata_db:
            try:
                ...
                if hasattr(file_metadata, 'document_analysis') and file_metadata.document_analysis:
                    ...
                    if hasattr(file_metadata.document_analysis, 'structure') and file_metadata.document_analysis.structure:
                        ...
                        if file_type is not None and file_type == FileType.CV:
                            ...
                            if hasattr(structure, 'personal_details') and structure.personal_details:
                                # Look for 'name' type in personal details
                                for detail in structure.personal_details:
                                    if hasattr(detail, 'type') and detail.type and detail.type.lower() == 'name':
